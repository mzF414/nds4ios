...
@implementation NDSMFIControllerSupport {
...
+(id) instance {
    static NDSMFIControllerSupport *instance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [NDSMFIControllerSupport new];
    });
...
-(void) onControllerConnected:(NSNotification *)notification {
    ...
    _controllerElementToButtonIdMapping = @{
        ...
        [NSValue valueWithNonretainedObject:_controller.gamepad.buttonA] : @(BUTTON_B),
        [NSValue valueWithNonretainedObject:_controller.gamepad.buttonY] : @(BUTTON_X),
        [NSValue valueWithNonretainedObject:_controller.gamepad.buttonX] : @(BUTTON_Y),
